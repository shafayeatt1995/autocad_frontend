  ...
  data() {
    return {
      ...
      layerMap: {
        ...
        FC: { layerName: "FACTORY", color: 210 },
        FP: { layerName: "FOOT PATH", color: 8 },
        G: { layerName: "RELIGIOUS", color: 202 },
        GAR: { layerName: "GARDEN", color: 7 },
        ...
        MH: { layerName: "UTILITY", color: 210 },
